/**
 * Email templates — funcoes que geram HTML de emails especificos.
 *
 * Refatorado de email.ts (623 linhas → 3 modulos).
 * Responsabilidade unica: templates de cada tipo de email.
 *
 * Usa: email-sender.ts (envio) + email-layout.ts (HTML shared).
 */

import { sendEmail } from "./email-sender";
import { wrap, ctaButton, featureItem, APP_URL } from "./email-layout";
